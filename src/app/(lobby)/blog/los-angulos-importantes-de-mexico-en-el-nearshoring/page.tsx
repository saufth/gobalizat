...
const article = blog.find((articleItem) => articleItem.title === 'Los ángulos importantes de México en el NEARSHORING')!
...
export default function LosAngulosImportantesDeMexicoEnElNearshoringPage () {
  return (
    <>
        ...
        <div className='container pt-spacing-5'>
          ...
          <div className='mt-spacing-6 md:mt-0 space-y-spacing-6'>
            {typeof article.description === 'string'
              ...
              : (
                <div className='mt-spacing-5 md:mt-0 space-y-spacing-4'>
                  {article.description.map((descriptionItem, key) => (
